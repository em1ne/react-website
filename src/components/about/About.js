    ...
    return (
        <div className='about'>
            <div className="container">
                ...
                <p>The Dev protocol system empowers developers, liquidity providers, and traders to participate in a financial marketplace that is open and accessible to all.</p>
                ...
                <a href="/" className="btn">Use Dev</a>
            </div>
        </div>
    )
}
